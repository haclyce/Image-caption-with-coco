...
class Attention(nn.Module):
    ...
    def forward(self, encoder_out, decoder_hidden):
        ...
        softmax = self.softmax(att)  # (batch_size, num_pixels)
        attention_weighted_encoding = (encoder_out * softmax.unsqueeze(2)).sum(dim=1)  # (batch_size, encoder_dim)

        return attention_weighted_encoding, softmax
